...
describe('SellerReportController', () => {
  ...
  describe('getSellerOrderReport', () => {
    it('should use the authenticated user id as the seller scope', async () => {
      /**
       * Arrange the authenticated seller and service response.
       */
      ...
      /**
       * Assert that the authenticated user's ID is used as the seller scope.
       *
  ...
  describe('getSellerProductSalesReport', () => {
    it('should use the authenticated user id for product sales reports', async () => {
      /**
       * Arrange the authenticated seller and service response.
       */
      const authenticatedUser = {
      ...
      /**
       * Assert that the authenticated user's ID defines the seller scope.
       */
